...
export { ReactComponent as DownArrowIcon } from './icons/down-arrow.svg'
...
export { ReactComponent as ActiveLikeIcon } from './icons/active-like-icon.svg'
export { ReactComponent as PassiveLikeIcon } from './icons/passive-like-icon.svg'
